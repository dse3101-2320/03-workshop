...
Download `wk3_cpi2023.pdf` from Canvas. The data contain **Singapore's Consumer Price Index (CPI) in 2023**. It was originally retrieved from [MAS](https://www.mas.gov.sg/monetary-policy/consumer-price-developments).
